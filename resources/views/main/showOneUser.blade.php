...
<style>
    ...
    <div class="text-center mb-4">
        <img src="{{ asset('storage/' . Auth::user()->imagePath) }}" alt="{{ Auth::user()->name }}" 
            style="width:96px;height:96px;object-fit:cover;border-radius:50%;border:4px solid #3b82f6;"
            class="mb-3">
...
<div class="container my-5 page-shell">
    ...
    <div class="row g-4">
        ...
        @empty
            <div class="col-12">
                <div class="alert alert-info rounded-4 shadow-sm">
                    No questions available.Click<a href="{{ route('showQuesForm') }}"> here </a> to create one.
                </div>
            </div>
        @endforelse
    </div>
